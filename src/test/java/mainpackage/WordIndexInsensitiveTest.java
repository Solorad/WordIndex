...
public class WordIndexInsensitiveTest extends WordIndexTest{
    ...
    static {
        ...
        addTest("src/main/resources/generatedSource1.txt",
                "src/main/resources/caseinsensitive/generatedFileResults1.txt");
        addTest("src/main/resources/generatedSource2.txt",
                "src/main/resources/caseinsensitive/generatedFileResults2.txt");
        addTest("src/main/resources/generatedSource3.txt",
                "src/main/resources/caseinsensitive/generatedFileResults3.txt");
        addTest("src/main/resources/HugeFile.txt",
                "src/main/resources/caseinsensitive/HugeFileResults.txt");
    }
    ...
    public WordIndexInsensitiveTest(String fileFrom, String fileAnswer) {
    ...
    public void testMultithreadThreadImpl() throws Exception {
        ...
        for (Map.Entry<String, Set<Integer>> entry : stringListMap.entrySet()) {
            Set<Integer> indexes4WordSet = multiThreadImpl.getIndexes4Word(entry.getKey());
